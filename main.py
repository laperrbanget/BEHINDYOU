...
class Menu:
    def __init__(self, screen, level_manager):
        ...
        # Warna tombol
        self.btn_color = (40, 40, 80)
        self.btn_hover_color = (80, 80, 160)
        self.btn_text_color = (200, 200, 220)
        self.btn_selected_color = (255, 255, 100)
...
class Game:
    ...
    def draw_path(self):
        ...
        if self.show_path and self.path_points and len(self.path_points) > 1:
            for i in range(len(self.path_points) - 1):
                ...
                for point in self.path_points:
                    ...
                    pygame.draw.circle(self.screen, (255, 255, 0), (px, py), 6)
    ...
    def show_path(self):
        ...
        try:
            ...
            if path:
                ...
                self.show_path = True
                print(f"Path ditemukan! {len(path)} langkah")  # Debug
            else:
                self.show_path = False
                self.path_points = []
                print("Tidak ada jalur ke pintu!")
        except Exception as e:
            print(f"Error di show_path: {e}")
            self.show_path = False
            self.path_points = []
